...
const Header = () => {
  ...
  return (
    ...
    <header className='w-full h-[100px] shadow-xl flex justify-center items-center relative bg-accent text-white'>
        ...
        <Link to="/home" className='text-[25px] font-bold  m-1'>Home Home edit</Link>
        <Link to="/home/contact" className='text-[25px] font-bold m-1' >Contact Meeeeeee</Link>
        ...
        <Link to="/home/login" className='text-[25px] font-bold m-1' >Login up</Link>
        {
